export interface IconProps {
  iconKey: "watch-list" | "app-logo" | "hamburger";
}

const Icon: React.FC<IconProps> = ({ iconKey }) => {
  const renderIcon = (key: IconProps["iconKey"]) => {
    switch (key) {
      case "watch-list":
        return (
          <svg
          ...
          >
            <title>Watch list side navigation element icon</title>
            <path d="M10 10h4" />
        ...
        return (
          ...
          >
            <g
              ...
              fontSize="none"
              textAnchor="none"
              style={{ mixBlendMode: "normal", height: 16, width: 16 }}
            >
              <title>
                Hamburger icon image for toggling application's side navigation
                bar collapse
              </title>
  ...
  return <div>{renderIcon(iconKey)}</div>;
};
